...
let borrowBook = async (req, res, next) => {
  ...
  try {
    ...
    console.log("USER FOUND from borrowbook:", user);
    console.log("BOOK FOUND from borrowbook:", book);
    ...
    let borrowRecord = await Borrow.create({
      userId,
      bookId,
      borrowDate,
      returnDate,
